...
// - Preserves existing brand blue; does not modify global themes

type Mode = "auto" | "light" | "dark";

type KiffCreatePageProps = {
  onCreate?: () => void;
  isSubmitting?: boolean;
  // Force a visual mode for places like Storybook; default respects app theme
  mode?: Mode;
};
...
export const KiffCreatePage: React.FC<KiffCreatePageProps> = ({
  ...
  // Derive colors for light/dark without touching global CSS
  ...
  const brandStart = "var(--brand-500, #5B8CFF)"; // preserve original blue
