# embedder_cache.py
"""
Centralized Embedder Cache for Kiff AI
Single source of truth for all embedder instances to avoid duplicate HF downloads.
Based on the proven legacy pattern from backend-lite_archived.
"""
...
def get_raw_model():
    """Get raw SentenceTransformer model using local cache"""
